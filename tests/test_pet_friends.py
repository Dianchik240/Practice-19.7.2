...
def test_add_new_pet_with_valid_data(name='Bob', animal_type='dog', age='2', pet_photo='images/Bod.jpg'):
...
def test_add_new_pet_with_invalid_age(name='Tom', animal_type='cat', age=invalid_age, pet_photo='images/Tom.jpg'):
...
def test_successful_delete_self_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pet(auth_key, "Боб", "пес", '1', "images/Bod.jpg")
        _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
...
def test_successful_update_self_pet_info(name='Луна', animal_type='тигр', age='11'):
...
def test_successful_update_self_pet_photo(pet_photo='images/Bob.jpg'):
